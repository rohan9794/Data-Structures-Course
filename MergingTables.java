...
public class MergingTables {
    ...
    void merge(Table destination, Table source) {
        ...
        if(source.rank<destination.rank){
            ...
            realSource.actualParent=realDestination;
    ...
    public void run() {
        ...
        for (int i = 0; i < n; i++) {
            ...
            if(numberOfRows<0 || numberOfRows>Math.pow(10,5)){
                System.exit(0);
            }
        ...
        for (int i = 0; i < m; i++) {
            ...
            if(destination<0 || source<0 || source>n-1 || destination>n-1){
                //System.out.println("exiting because source or destination don't comply..");
                System.exit(0);
            }
